...
This case includes out-of-order labeled answers, `5(a)` / `5(b)` subparts, an unanswered question, an unmatched `Ans 9`, a multi-page answer for Q6 with an unlabeled continuation, and page navigation/highlight checks.
...
4. `Ans 9` appears in Unmatched answers.
